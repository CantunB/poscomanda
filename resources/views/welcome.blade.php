                    ...
                    <div class="full">
                        <div class="right_header_info">
                            <ul>
                                ...
                                <li class="dinone"><img style="margin-right: 15px;height: 21px;position: relative;top: -2px;" src="images/location_icon.png" alt="#">
                                    <a href="#">104 New york , USA</a></li>
                                @if (Route::has('login'))
                                <li class="button_user">
                                    @auth
                                        <a href="{{ url('/home') }}">Home</a>
                                    @else
                                        <a class="button active" href="{{ route('login') }}">{{ __('Login') }}</a>
...
<!-- end Our Client -->
    ...
    <fooetr>
        <div class="footer">
            ...
            <div class="copyright">
                <div class="container">
                    <p>© 2020 All Rights Reserved.<a href="https://html.design/">Bernabe Cantun Dominguez</a></p>
                </div>
            </div>
        </div>
    </fooetr>
